...
server <- function(input, output) {
  ...
  output$plot <- renderPlotly({
     lightcond_colors <- c("Daylight" = "blue", "Dark - Street Lights On" = "green", "Dusk" = "orange", "Dawn" = "red", "Dark - No Street Lights" = "purple", "Dark - Street Lights Off" = "brown", "Unknown" = "gray")
    # Creating the plot
