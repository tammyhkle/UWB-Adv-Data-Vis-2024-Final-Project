...
print(colnames(Seattle_Car_Crashes))

# convert "Location" column to character type
if ("Location" %in% colnames(Seattle_Car_Crashes)) {
  Seattle_Car_Crashes$Location <- as.character(Seattle_Car_Crashes$Location)
} else {
  stop("Column 'Location' not found in the dataset.")
}
...
# print
print(head(addresses))  # Check the first few addresses
